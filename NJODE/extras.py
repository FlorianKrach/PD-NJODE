...
def get_cross_validation(
    ...
    :param param_combinations: list of dict, each dict defines one combination
            of params, which are used as one sample for the cross-validation
            (mean is then taken over all other params that are not specified,
            where the specified params are the same)
...
def plot_loss_comparison(
    ...
    for i, pc in enumerate(param_combinations):
