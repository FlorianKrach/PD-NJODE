...
plot_paths_LOB_dict = {
    'model_ids': [21], 'saved_models_path': LOB_models_path,
...
overview_dict_retrainLOB = dict(
    ...
    val_test_params_extract=(
        ("max", "epoch", "epoch", "epochs_trained"),
        ("min", "classification_val_loss", "classification_val_loss",
         "classification_val_loss_min"),
        ("max", "evaluation_f1score", "evaluation_f1score",
         "evaluation_f1score_max"),
        ("min", "classification_val_loss", "evaluation_f1score",
         "f1score_at_val_loss_min"),
    ),
